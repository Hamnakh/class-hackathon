...
import img1 from "@/public/image 33 (2).png"
import img2 from "@/public/image 34.png"
import img3 from "@/public/image 35.png"
        ...
        <div>
            <div className="h-vh bg-white">
                <div className="flex flex-col  h-[128px] w-[387px] justify-center items-start pl-36 pt-20 ">
                    <h1 className="styles text-gray-300 text-[64px] w-[387px] font-sans text-start font-light flex flex-col" >Sample <span className="font-bold text-black" >Project 2</span> </h1>
                </div>
