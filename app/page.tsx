...
import frontimage from "@/public/Rectangle 6.png"
import leftb from "@/public/Frame 8.png"
import rightb from "@/public/Frame 9.png"
import view from "@/public/arrow-2-right-long.png"
import slidenumbers from "@/public/slide-numbers.png"
import imageone from "@/public/Rectangle 8.png"
// import image2 from "@/public/Rectangle 9.png"
import imagetag from "@/public/Rectangle 9.png"
import imagetags from "@/public/Rectangle 10.png"
import rightarrow from "@/public/arrow-2-right-long (1).png"
import imagejpg from "@/public/image 15.png"
import imagepic from "@/public/image 16.png"
import imageall from "@/public/image 17.png"
import imagesfive from "@/public/image 18.png"
import contactimage from "@/public/image 12.png"
        ...
        <div className="h-[465px] w-[1170px] bg-gray-100 flex justify-between px-20 ">
          <div className="flex p-10 gap-10">
            <div className="flex flex-col gap-10">
              ...
              <Image src={imagetags} alt="image"></Image>
            </div>
            <div className="flex items-center">
              <Image src={imagetag} alt="image"></Image>
            </div>
        ...
        <div className="h-[765px] w-[1170px] flex flex-col justify-between">
              ...
              <div className="h-[255px] w-[570px] bg-neutral-700 pt-6 pl-20">
                ...
                <div className="flex ">
                  <div className="h-[24px] w-[129px] flex justify-center  items-center">
                    <Link href="/projects" className="h-[24px] w-[121px] text-white hover:underline">VIEW MORE</Link> <div><Image src={rightarrow} alt="view projects arrow"></Image></div>
                  </div>
                </div>
              </div>


              <Image src={imagejpg} alt="imgage"></Image>
            </div>
            <div className="flex justify-between">
              <Image src={imagepic} alt="imgage"></Image>
              <Image src={imageall} alt="imgage"></Image>
              <Image src={imagesfive} alt="imgage"></Image>
          ...
          <div className="flex justify-end">
            <div className="h-[71px] w-[222px] bg-neutral-800 flex justify-center hover:bg-neutral-700  items-center">
              <Link href="/projects" className="h-[24px] w-[121px] text-white">ALL PROJECTS</Link> <div><Image src={rightarrow} alt="view projects arrow"></Image></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex justify-between py-6">
            ...
            <form action="/email-send" className="flex flex-col gap-2">
              ...
              <div className="flex justify-start mt-10">
                <div className="h-[71px] w-[222px] bg-neutral-800 flex justify-center hover:bg-neutral-700  items-center">
                  <button className="h-[24px] w-[121px] text-white">SEND EMAIL</button> <div><Image src={rightarrow} alt="view projects arrow"></Image></div>
                </div>
              </div>
