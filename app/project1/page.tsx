        ...
        <div>
            <div className="h-vh bg-white">
                <div className="flex flex-col  h-[128px] w-[387px] justify-center items-start pl-36 pt-20 ">
                    <h1 className="styles text-gray-300 text-[64px] w-[387px] font-sans text-start font-light flex flex-col" >Sample <span className="font-bold text-black" >Project 1</span> </h1>
                </div>
